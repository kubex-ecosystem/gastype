...
func init() {
	...
	if loggerCore == nil {
		loggerCore = logz.NewLogger("GoSpyder-core")
	}

	logger.SetLevel("DEBUG")
	lgCfg := logger.GetConfig()
	lgCfg.SetFormat("json")
	lgCfg.SetLevel(logger.GetLevel())
	logger.SetConfig(lgCfg)
}
...
func Debug(args ...interface{}) {
	logger.Debug("Debug", map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Debug", "args": args})
}

// Debugf logs a formatted message at level Debug on the standard logger.
func Debugf(format string, args ...interface{}) {
	logger.Debug(format, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Debug", "args": args})
}
...
func Info(args ...interface{}) {
	logger.Info(fmt.Sprintf("%s", args), map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Info", "args": args})
}

// Infof logs a formatted message at level Info on the standard logger.
func Infof(format string, args ...interface{}) {
	logger.Info(format, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Info", "args": args})
}
...
func Warn(args ...interface{}) {
	logger.Warn("Warn", map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Warn", "args": args})
}

// Warnf logs a formatted message at level Warn on the standard logger.
func Warnf(format string, args ...interface{}) {
	logger.Warn(format, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Warn", "args": args})
}
	...
	for i, arg := range args {
		if i > 0 {
			if s, ok := arg.(string); ok {
				if i%2 == 0 {
					msg += fmt.Sprintf(" %v", s)
					logger.Error(msg, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Error", "args": args})
					msg = ""
				} else {
					msg += fmt.Sprintf(" %v:", s)
				}
			...
			msg += fmt.Sprintf("Message: %v", arg)
		}
	}
	if msg != "" {
		logger.Error(msg, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Error", "args": args})
	} else {
		logger.Error("Error", map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Error", "args": args})
	}
}

// Errorf logs a formatted message at level Error on the standard logger.
func Errorf(format string, args ...interface{}) {
	logger.Error(format, map[string]interface{}{"context": "GoSpyder", "pkg": "log", "method": "Error", "args": args})
}
